...
public class ReplicaManager2 extends Thread{
    ...
    private static MTLServerRM2 mtlServerRM2;
    private static OTWServerRM2 otwServerRM2;
    private static TORServerRM2 torServerRM2;
    ...
    private int ReplicaManagerUDPPortNumber = IPPortAddress.RM2_UDP_SEND_PORT;
    ...
    public ReplicaManager2() throws Exception {
        //start all three servers
        mtlServerRM2 = new MTLServerRM2();
        otwServerRM2 = new OTWServerRM2();
        torServerRM2 = new TORServerRM2();
    }

    public static void main(String[] args) throws Exception {
        ReplicaManager2 RM2 = new ReplicaManager2();
        RM2.start();
        ListenThreadFromFE listenThreadFromFE = new ListenThreadFromFE(RM2);
    ...
    public void run(){
        ...
        try{
            ...
            System.out.println("RM2 UDP Listen Started");
        ...
        switch (operationType){
            case "add":
                switch (clientID.substring(0, 3)) {
                    case "MTL":
                        resultArr = mtlServerRM2.serverOBJ.addEvent(clientID,splitMessages[3],splitMessages[4],Integer.parseInt(splitMessages[5]) );
                        break;
                    case "OTW":
                        resultArr = otwServerRM2.serverOBJ.addEvent(clientID,splitMessages[3],splitMessages[4],Integer.parseInt(splitMessages[5]) );
                        break;
                    case "TOR":
                        resultArr = torServerRM2.serverOBJ.addEvent(clientID,splitMessages[3],splitMessages[4],Integer.parseInt(splitMessages[5]) );
                        break;
                    default:
            ...
            case "remove":
                switch (clientID.substring(0, 3)) {
                    case "MTL":
                        resultArr = mtlServerRM2.serverOBJ.removeEvent(clientID,splitMessages[3],splitMessages[4]);
                        break;
                    case "OTW":
                        resultArr = otwServerRM2.serverOBJ.removeEvent(clientID,splitMessages[3],splitMessages[4]);
                        break;
                    case "TOR":
                        resultArr = torServerRM2.serverOBJ.removeEvent(clientID,splitMessages[3],splitMessages[4]);
                        break;
                    default:
                        System.out.println("wrong");
                        break;
            ...
            case "list":
                switch (clientID.substring(0, 3)) {
                    case "MTL":
                        resultArr = mtlServerRM2.serverOBJ.listEventAvailability(clientID,splitMessages[3]);
                        break;
                    case "OTW":
                        resultArr = otwServerRM2.serverOBJ.listEventAvailability(clientID,splitMessages[3]);
                        break;
                    case "TOR":
                        resultArr = torServerRM2.serverOBJ.listEventAvailability(clientID,splitMessages[3]);
                        break;
                    default:
                        System.out.println("wrong");
                        break;
            ...
            case "book":
                switch (clientID.substring(0, 3)) {
                    case "MTL":
                        resultArr = mtlServerRM2.serverOBJ.bookEvent(clientID,splitMessages[3],splitMessages[4]);
                        break;
                    case "OTW":
                        resultArr = otwServerRM2.serverOBJ.bookEvent(clientID,splitMessages[3],splitMessages[4]);
                        break;
                    case "TOR":
                        resultArr = torServerRM2.serverOBJ.bookEvent(clientID,splitMessages[3],splitMessages[4]);
                        break;
                    default:
                        System.out.println("wrong");
                        break;
            ...
            case "schedule":
                switch (clientID.substring(0, 3)) {
                    case "MTL":
                        resultArr = mtlServerRM2.serverOBJ.getBookingSchedule(clientID);
                        break;
                    case "OTW":
                        resultArr = otwServerRM2.serverOBJ.getBookingSchedule(clientID);
                        break;
                    case "TOR":
                        resultArr = torServerRM2.serverOBJ.getBookingSchedule(clientID);
                        break;
                    default:
                        System.out.println("wrong");
                        break;
            ...
            case "cancel":
                switch (clientID.substring(0, 3)) {
                    case "MTL":
                        resultStr = mtlServerRM2.serverOBJ.cancelEvent(clientID,splitMessages[3],splitMessages[4]);
                        break;
                    case "OTW":
                        resultStr = otwServerRM2.serverOBJ.cancelEvent(clientID,splitMessages[3],splitMessages[4]);
                        break;
                    case "TOR":
                        resultStr = torServerRM2.serverOBJ.cancelEvent(clientID,splitMessages[3],splitMessages[4]);
                        break;
                    default:
                        System.out.println("wrong");
                        break;
            ...
            case "swap":
                switch (clientID.substring(0, 3)) {
                    case "MTL":
                        resultArr = mtlServerRM2.serverOBJ.swapEvent(clientID,splitMessages[3],splitMessages[4],splitMessages[5],splitMessages[6]);
                        break;
                    case "OTW":
                        resultArr = otwServerRM2.serverOBJ.swapEvent(clientID,splitMessages[3],splitMessages[4],splitMessages[5],splitMessages[6]);
                        break;
                    case "TOR":
                        resultArr = torServerRM2.serverOBJ.swapEvent(clientID,splitMessages[3],splitMessages[4],splitMessages[5],splitMessages[6]);
                        break;
                    default:
                        System.out.println("wrong");
                        break;
