...
public class ServerImplementation implements ServerInterface{
    ...
    public ServerImplementation(int firstRemoteUDPPort,int secondRemoteUDPPort,String serverName) throws Exception {
        super();
        ...
        fh = new FileHandler("src/RM2/RM2_log/"+serverName+".log",true);
    ...
    public synchronized ArrayList<String> addEvent(String MID,String eventID, String eventType, int bookingCapacity){
        ...
        if(!eventID.substring(0,3).equals(MID.substring(0,3))){
            returnMessage.add("Fail");
            returnMessage.add("Cannot add event in other city");
            String msg = "Fail. Cannot add event in other city";
    ...
    public synchronized ArrayList<String> removeEvent(String MID , String eventID, String eventType){
        ...
        if(!eventID.substring(0,3).equals(MID.substring(0,3))){
            returnMessage.add("Fail");
            returnMessage.add("Cannot remove event in other city");
            String msg = "Fail. Cannot remove event in other city";
            serverLogger.info(msg);
            System.out.println(msg);
            return returnMessage;
        }
    ...
    public synchronized ArrayList<String> listEventAvailability(String MID, String eventType){
        ...
        for (int i =0; i<returnMessage.size(); i++) {
        	System.out.println(returnMessage.get(i));
        }
        return returnMessage;
    }
    ...
    public synchronized ArrayList<String> swapEvent(String customerID, String newEventID, String newEventType, String oldEventID, String oldEventType) {
        ...
        if(newEventID.equals("Trade Shows")){
            newEventID = "TradeShows";
        }
        if(oldEventID.equals("Trade Shows")){
            oldEventID = "TradeShows";
        }
        ...
        if ( (newEventID.equals(oldEventID) ) && ( newEventType.equals(oldEventType) )){
            ...
            returnMessage.add("You are trying to swap two identical events, no action is taken.\"+\"\\n");
        ...
        if ( ! bookEventResult.get(0).equals("Success")) { //can't book the new event
            ...
            returnMessage.add("Fail in swaping, because can't book new event. New event id: \" + newEventID +\" new event type: \"+newEventType+\"\\n");
            ...
            if (cancelEventResult.equals("Success")) { //book new and cancel old both succeed
                ...
                System.out.println("Succeed in swapping two events.");
                return returnMessage;
                ...
                System.out.println("Fail. Able to book but fail in cancelling.");
                return returnMessage;
            }
        }
    }
