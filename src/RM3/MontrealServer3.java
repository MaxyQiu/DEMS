...
public class MontrealServer3 implements ServerInterface, Runnable {

    private HashMap<String, HashMap<String, Event>> database;
    private HashMap<String, HashMap<String, int[]>> bookingCount;


    public final static String NAME = "MONTREAL";

    private final static int UDPPORT = MUDPPORT;
    private final static String shortName = "MTL";

    public MontrealServer3() {
        ...
        /*
        database.get("Conferences").put("MTLE100519", new Event("MTLE100519", "Conferences", 20));
        database.get("Conferences").put("MTLE110519", new Event("MTLE110519", "Conferences", 15));
        database.get("Conferences").put("MTLA110519", new Event("MTLA110519", "Conferences", 2));


        database.get("Seminars").put("MTLA210519", new Event("MTLA210519", "Seminars", 40));
        database.get("Trade Shows").put("MTLA210519", new Event("MTLE100519", "Trade Shows", 30));
        */
    }
        ...
        synchronized (this){
            ...
            if(eventTypeDB.containsKey(eventID)){
                ...
                for (String customerID: customerList) {
                    ...
                    else if(customerID.substring(0,3).equals("OTW")){
