...
public class ServerListenThread extends Thread{
    ...
    private ServerImplementation serverOBJ;
    private int localUDPPortNumber;

    public ServerListenThread(ServerImplementation serverOBJ,int localUDPPortNumber){
        this.localUDPPortNumber = localUDPPortNumber;
    ...
    public void run(){
        ...
        try {
            aSocket = new DatagramSocket(localUDPPortNumber);
            ...
            while (true) {
                ...
                if (action.equals("listEventAvailability")){
                    ...
                    ConcurrentHashMap<String, ArrayList<Integer>> eventSubHashMap = serverOBJ.listEventAvailabilityForUDP(eventType);
                    ...
                    ArrayList<String> bookEventResult = serverOBJ.bookEventForUDP(customerID, eventID, eventType);
                    ...
                    if (serverOBJ.getcBookingRecord().containsKey(customerID)) { //if this customer has record in that city
                        ArrayList<String> eventTypeAndIDAL = serverOBJ.getBookingScheduleForUDP(customerID);
                    ...
                    re = serverOBJ.cancelEventForUDP(customerID, eventID, eventType).trim();
